const C='coaching-v20';
const A=['./','./index.html','./manifest.webmanifest','./icon.svg','./coaching-v10.css?v=14','./polish-v13.css?v=13','./coaching-v15.css?v=1','./form-controls-v19.css?v=1','./appointment-v20.css?v=1','./coaching-v10.js?v=14','./coaching-v15-addon.js?v=2','./appointment-v20.js?v=1'];
